...
function clearAddressFields(type) {
    ...
    const logradouroInput = document.getElementById(type + "-logradouro");
    const bairroInput = document.getElementById(type + "-bairro");
    const cidadeInput = document.getElementById(type + "-cidade");
    const estadoInput = document.getElementById(type + "-estado");
    const errorSpan = document.getElementById(type + "-cep-error");
...
async function consultarCep(inputElement, type) {
    ...
    const cidadeInput = document.getElementById(type + "-cidade");
    const estadoInput = document.getElementById(type + "-estado");
    const cepErrorSpan = document.getElementById(type + "-cep-error");
